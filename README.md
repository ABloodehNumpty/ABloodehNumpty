...
|---------|-----------------------------------|----------| 
| STAT448 | Big Data                          | B-       | 
| DIGI405 | Texts, Discourses and Data        | B-       | 
| STAT462 | Data Mining                       | B        | 
| DATA420 | Scalable Data Science             | Enrolled | 
| PHIL424 | Ethics of Artificial Intelligence | Enrolled | 
| DATA601 | Applied Data Science Project      | Enrolled | 
...
(https://github.com/ABloodehNumpty/Deflect-Me-Not-additions) 

A published mod developed across four iterative phases, extending an existing Elden Ring mod with new mechanics, visual effects, and a redesigned customisation system. 
**Key achievements:** 
- 97+ unique downloads from real users 
- 124 hand-crafted animations with synchronised effects
...
|---------|-------|-------------| 
| 🔍 Tweet Sentiment Classifier | Python, Scikit-learn, NLP | Multi-class text classification pipeline | 
